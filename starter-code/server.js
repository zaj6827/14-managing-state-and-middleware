...
const conString = 'postgres:postgres:pass@localhost:5432:kilovolt'; // TODO: Don't forget to set your own conString
...
// This function is calling the github api, and passing in the token as params. We're using this function to make sure that our GITHUB_TOKEN is hidden inside the environment, for our security.
...
// The route is returning information to the user based on the user's request.
...
// COMMENT: What is this route doing? Where does it receive a request from?
// This route is for the user's input when making a new article. Using SQL, we're pushing the information they gave us into the authors table with the author information, and pushing the actual article content into the articles table. If we need both at once, we can always use a JOIN to get all the information at once.
